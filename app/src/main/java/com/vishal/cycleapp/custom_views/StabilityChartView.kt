...
class StabilityChartView @JvmOverloads constructor(
    ...
    private val bandPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = Color.parseColor("#C5C0E0")
        alpha = 120
        style = Paint.Style.FILL
    }

    private val linePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = Color.parseColor("#9B8EC4")
        strokeWidth = 3f
    ...
    private val yLabels = listOf("32d", "28d", "24d")
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val tooltipW = 160f
        val tooltipH = 70f
        val tooltipX = dotX - tooltipW / 2
        val tooltipY = dotY - tooltipH - 20f

        canvas.drawRoundRect(
            RectF(tooltipX, tooltipY, tooltipX + tooltipW, tooltipY + tooltipH),
            12f,
            12f,
            tooltipPaint
        )

        canvas.drawText("Stability", tooltipX + tooltipW / 2, tooltipY + 26f, tooltipTextPaint)
        canvas.drawText("Improving", tooltipX + tooltipW / 2, tooltipY + 56f, tooltipTextPaint)
        ...
        labels.forEachIndexed { i, label ->
            ...
            canvas.drawText(label, x, h - 2f, paint)
        }
    }
}